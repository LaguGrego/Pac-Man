...
///fantasma que persigue a PACMAN

Fantasma_1::Fantasma_1(int X,int Y){
	llenar_animacion_fantasma("AnimacionFantasma/Fantasma_Rojo.png");
	SF.setOrigin(8.f,8.f);
	SF.setPosition(X,Y);
}

void Fantasma_1::mover(sf::Vector2f posicion_pacman,char Mapa[30][41]){
